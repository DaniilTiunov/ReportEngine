...
public partial class MainWindow : Window
{
    ...
    private void StartStandardApp(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            {
                MessageBox.Show("Приложение 'Стенды КИПиА' не найдено!", "Ошибка", MessageBoxButton.OK,
    ...
    private void StartAtomicApp(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (!File.Exists(appPath))
            {
                MessageBox.Show("Приложение 'АтомСтенды КИПиА' не найдено!", "Ошибка", MessageBoxButton.OK,
                    MessageBoxImage.Error);
                return;
            }
