...
public static class ObvyzkaModelWrapper
{
    public static ObvyazkaInStand CloneForStand(ObvyazkaInStand source, int newStandId)
    {
        return new ObvyazkaInStand
        {
            ...
            MaterialLineId = source.MaterialLineId,
            MaterialLineType = source.MaterialLineType,
            ...
            TreeSocketId = source.TreeSocketId,
            TreeSocketType = source.TreeSocketType,
            KMCH = source.KMCH,
            ...
            KMCHId = source.KMCHId,
            KMCHType = source.KMCHType,
            ...
            ArmatureId = source.ArmatureId,
            ArmatureType = source.ArmatureType,
            NN = source.NN,
