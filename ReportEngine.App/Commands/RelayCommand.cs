namespace ReportEngine.App.Commands
{
    ...
    public class RelayCommand : BaseCommand
    {
        ...
        /// <param name="canExecute">Делегат, определяющий, может ли команда быть выполнена. Если null, команда всегда может быть выполнена.</param>
        ...
        public RelayCommand(Action<object> execute, Func<object, bool> canExecute = null)
        {
            ...
            _execute = execute ?? throw new ArgumentNullException(nameof(execute)); // Устанавливаем делегат для выполнения команды и проверяем его на null
        }
