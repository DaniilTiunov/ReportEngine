    ...
    public static class MainWindowCommandsInitializer
    {
        ...
        public static void InitializeGenericCommands(MainWindowViewModel vm)
        {
            ...
            vm.GenericEquipCommandProvider.OpenStainlessPipeCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<StainlessPipe, StainlessPipe>, vm.CanAllCommandsExecute);

            vm.GenericEquipCommandProvider.OpenHeaterArmatureCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<HeaterArmature, HeaterArmature>, vm.CanAllCommandsExecute);
            vm.GenericEquipCommandProvider.OpenCarbonArmatureCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<CarbonArmature, CarbonArmature>, vm.CanAllCommandsExecute);
            vm.GenericEquipCommandProvider.OpenStainlessArmatureCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<StainlessArmature, StainlessArmature>, vm.CanAllCommandsExecute);

            vm.GenericEquipCommandProvider.OpenCarbonSocketsCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<CarbonSocket, CarbonSocket>, vm.CanAllCommandsExecute);
            vm.GenericEquipCommandProvider.OpenStainlessSocketsCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<StainlessSocket, StainlessSocket>, vm.CanAllCommandsExecute);
            vm.GenericEquipCommandProvider.OpenHeaterSocketsCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<HeaterSocket, HeaterSocket>, vm.CanAllCommandsExecute);
            ...
            vm.GenericEquipCommandProvider.OpenDrainageBracesCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<DrainageBrace, DrainageBrace>, vm.CanAllCommandsExecute);
            ...
            vm.GenericEquipCommandProvider.OpenCabelProductionCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<CabelProduction, CabelProduction>, vm.CanAllCommandsExecute);
            vm.GenericEquipCommandProvider.OpenCabelProtectionCommand =
                new RelayCommand(vm.OnOpenGenericWindowCommandExecuted<CabelProtection, CabelProtection>, vm.CanAllCommandsExecute);
