...
namespace ReportEngine.Domain.Repositories
{
...

    {
        ...
        private void InitializeHandlers()
        {
            ...
            _handlers.Add(typeof(CarbonArmature), async expr => await GetAsync((Expression<Func<CarbonArmature, bool>>)expr));
            _handlers.Add(typeof(HeaterArmature), async expr => await GetAsync((Expression<Func<HeaterArmature, bool>>)expr));
            _handlers.Add(typeof(StainlessArmature), async expr => await GetAsync((Expression<Func<StainlessArmature, bool>>)expr));
            ...
            _handlers.Add(typeof(StainlessSocket), async expr => await GetAsync((Expression<Func<StainlessSocket, bool>>)expr));
            ...
            _handlers.Add(typeof(CabelProduction), async expr => await GetAsync((Expression<Func<CabelProduction, bool>>)expr));
            _handlers.Add(typeof(CabelProtection), async expr => await GetAsync((Expression<Func<CabelProtection, bool>>)expr));
        ...
        public async Task<IBaseEquip?> GetByNameAsync(Type entityType, object value)
        {
            ...
            {
                return await handler(predicate);
            }
